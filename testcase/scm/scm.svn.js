module.exports = {
  ...
  'commit': function(browser) {
    browser
      .click('#dlg_svn .close')
      .waitForElementNotVisible('#dlg_svn', 2000)
      .move_to_project(this.project_name) // go to authorized project
  ...
  'remove': function(browser) {
    browser
      .click('#svn_treeview [aria-level="3"]:nth-child(2)') // file status -> auto check
      .waitForElementNotVisible('#dlg_loading_bar', 10000)
      .waitForElementVisible('#svn_status_files input:checked', 2000)
      .click('#svn_remove_bt')
      .waitForElementVisible('#dlg_confirmation', 2000)
  ...
  'blame': function(browser) {
    ...
    browser
      .click('#project_treeview [aria-level="3"]:nth-child(3) .jstree-anchor')
      .getText('#project_treeview [aria-level="3"]:nth-child(3) .jstree-anchor', function(result) {
