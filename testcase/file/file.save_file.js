module.exports = {
  ...
  'file_save_file_as' :  function (browser) {
    ...
    browser
      .click('#main-menu-file > a')
      .waitForElementPresent('#main-menu-file.open', 2000)
      .click("#main-menu-file a[action=save_as_file]")
      .waitForElementVisible("#dlg_save_as_file", 3000)
      .setValue('#file_save_as_target_name', new_name)
      .click('#g_saf_btn_ok')
      .waitForElementNotVisible("#dlg_save_as_file", 10000)
      .waitForElementPresent('.jstree-leaf[id$="save_as_file"]', 2000)
